...
|---|---:|---:|---:|---:|---:|---:|---:|
| 12 months | $10,512.15 | +5.12% | 136 | 44.9% | -1.37% | 1.56 | 2.04 |
...
|---|---:|---:|---:|---:|---:|---:|
| `capitol_copy` | 0 | n/a | n/a | $0.00 | n/a | n/a |
| `gap_up` | 0 | n/a | n/a | $0.00 | n/a | n/a |
| `ma_crossover` | 21 | 42.9% | +2.70% | $108.33 | +11.78% | -5.55% |
| `momentum` | 63 | 44.4% | +0.83% | $213.59 | +26.96% | -5.28% |
| `range_breakout` | 3 | 100.0% | +4.60% | $27.40 | +7.19% | +3.28% |
| `relative_strength` | 31 | 41.9% | +0.38% | $23.08 | +14.48% | -5.28% |
| `rsi_reversion` | 18 | 44.4% | -0.14% | $-4.25 | +7.81% | -4.24% |
...
| Q2 2025 | $9,899.99 | $9,886.68 | -0.13% | 29 | 37.9% |
| Q3 2025 | $9,870.67 | $10,136.54 | +2.69% | 35 | 57.1% |
| Q4 2025 | $10,138.77 | $10,195.11 | +0.56% | 40 | 45.0% |
| Q1 2026 | $10,194.80 | $10,512.15 | +3.11% | 20 | 60.0% |
...
|---|---|---|---:|---:|---:|---:|
| Current guarded default strategy set | On | `momentum`, `relative_strength`, `rsi_reversion`, `capitol_copy`, `ma_crossover`, `range_breakout` | +5.12% | 136 | 44.9% | -1.37% |
...
python3 scheduler/run_backtest.py --days 30 --fund 10000 --end-date 02/14/2026
...
|---|---|---:|---:|---:|---:|---:|---:|
| `default_12m_costed` | FAIL | +5.12% | -1.37% | 136 | 44.9% | 1.56 | 2.04 |
| `default_6m_costed` | PASS | +4.44% | -0.75% | 75 | 49.3% | 2.13 | 3.86 |
| `crypto_12m_costed` | FAIL | +1.37% | -0.35% | 24 | 50.0% | 2.79 | 1.88 |
...
return lower bound +0.96% versus +10.00% required, profit-factor lower bound
1.08 versus 1.50 required, and daily-Sharpe lower bound 0.39 versus 1.00
required; crypto 12-month return lower bound +0.04% versus +5.00% required and
profit-factor lower bound 1.29 versus 2.00 required.
