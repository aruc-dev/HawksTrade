...
""".strip()
            ...
            colored_terminal = health.format_terminal_report(report, use_color=True)
            ...
            self.assertIn("Alpaca connectivity : OK", terminal)
            self.assertIn("Errors in logs     : NO", terminal)
            self.assertIn("\x1b[", colored_terminal)
